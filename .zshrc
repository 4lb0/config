...
export PATH=$HOME/bin:/usr/local/bin:$NPM_PACKAGES/bin:$RUBY_LOCAL:$ANDROID_SDK_ROOT/emulator:$ANDROID_SDK_ROOT/platform-tools:$DENO_INSTALL:$SOLANA_INSTALL:$YARN_BIN:$YARN_MODULES_BIN:$PATH
